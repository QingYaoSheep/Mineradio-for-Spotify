...
!macro customInstall
  ...
  Delete "$SMPROGRAMS\Mineradio.lnk"
...
Function MineradioWelcomeShow
  ...
  ${NSD_CreateLabel} 22u 42u 226u 30u "Mineradio for Spotify"
  Pop $0
  ...
  ${NSD_CreateLabel} 22u 96u 238u 24u "安装 Spotify 专属可视化播放器。为兼容旧版本，默认目录仍为 D:\Mineradio。"
  Pop $0
