...
function normalizeWallpaperState(previous, payload, enabledOverride) {
  ...
  return {
    enabled,
    title: String(Object.prototype.hasOwnProperty.call(source, 'title') ? source.title : current.title || 'Better Radio').slice(0, 512),
...
class DesktopWallpaperRuntime {
  ...
  createWindow() {
    ...
    const win = new this.BrowserWindow({
      ...
      skipTaskbar: true,
      show: false,
      title: 'Better Radio Desktop Wallpaper',
      webPreferences: {
